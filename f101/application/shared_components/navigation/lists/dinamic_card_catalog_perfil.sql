prompt --application/shared_components/navigation/lists/dinamic_card_catalog_perfil
begin
--   Manifest
--     LIST: Dinamic Card Catalog Perfil
--   Manifest End
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(248103603596426)
,p_name=>'Dinamic Card Catalog Perfil'
