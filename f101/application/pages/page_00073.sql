...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2972885214985525)
,p_name=>'P73_CODIGO_MOTIVO_DEVOLUCION'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(2971630906985512)
,p_item_source_plug_id=>wwv_flow_imp.id(2971630906985512)
,p_source=>'CODIGO_MOTIVO_DEVOLUCION'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_is_persistent=>'N'
,p_attribute_01=>'Y'
...
'    end;'))
,p_attribute_07=>'P73_TIPO_INTERESADO,P73_TIPO_PERSONA'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
...
'                           tablascomunes.obtiene_parametro(''APEX'', ''UNIDAD_Direccion_General''));',
'  -- si no hay DG obtiene la SG',
'  if nIdUnidadOrganizativa is null then',
'    nIdUnidadOrganizativa  := tablascomunes.consulta.Obtiene_Unidad_Superior(:P73_EXP_DUNIDADIORG, ',
'                           tablascomunes.obtiene_parametro(''APEX'', ''UNIDAD_Secretaria_General''));   	                                                      ',
'  end if;',
'',
