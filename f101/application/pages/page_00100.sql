...
'select cif_nif, tipodeadministrado, tipodedocumento, nombre, primerapellido, segundoapellido, nombredepila, domiciliosocial, codigoprovincia,',
...
'            and ped.CODIGOPEDANIA > 0) as codigopedania, codigopostal, telefono, direccionemail, representante_legal, pagina_web, cif_nif_representante_legal, numerosoporte,',
'  nif,fecha_nacimiento, codigo_pais_nacionalidad, sexo',
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'CIF_NIF:TIPODEADMINISTRADO:TIPODEDOCUMENTO:NOMBRE:PRIMERAPELLIDO:SEGUNDOAPELLIDO:NOMBREDEPILA:DOMICILIOSOCIAL:CODIGOPROVINCIA:CODIGOMUNICIPIO:CODIGOPEDANIA:CODIGOPOSTAL:TELEFONO:DIRECCIONEMAIL:CIF_NIF_REPRESENTANTE_LEGAL:REPRESENTANTE_LEGAL:PAGINA_WE'
||'B:NUMEROSOPORTE:CODIGO_PAIS_NACIONALIDAD:SEXO:'
);
