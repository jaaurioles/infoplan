...
'SELECT distinct',
'    -- LIENZO 1 DOCUMENTO',
'    DECODE(de.origen_documento, 1, ''A'', 2, ''E'', 3, ''S'', 4, ''X'', 5, ''R'', 6, ''F'', 7, ''C''),',
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(5156216216205338)
,p_db_column_name=>'DECODE(DE.ORIGEN_DOCUMENTO,1,''A'',2,''E'',3,''S'',4,''X'',5,''R'',6,''F'',7,''C'')'
,p_display_order=>430
,p_column_identifier=>'BD'
,p_column_label=>'Decode(de.origen Documento,1,&#x27;a&#x27;,2,&#x27;e&#x27;,3,&#x27;s&#x27;,4,&#x27;x&#x27;,5,&#x27;r&#x27;,6,&#x27;f&#x27;,7,&#x27;c&#x27;)'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_use_as_row_header=>'N'
);
...
,p_report_columns=>'ID_DOCUMENTO:DOCUMENTO_ELECTRONICO:NOMBRE_DOCUMENTO:DESCARGA_DOCUMENTO:BTN_SUBIR_DOCUMENTO_EXISTENTE:ITM_LOGIN:ITM_FECHA_MODIFICACION:ITM_DESCRIPCION_TRAMITE:ID_ACTUACION:ITM_ESTADO_PORTAFIRMAS:ITM_ESTADO_NOTIFICACION:ITM_OBSERVACIONES:BTN_EDITOR_OBS'
||'ERVACIONES:VERSION:ID_BLOB:CAS_HAY_FICHERO:CAS_FILTRO_ACTUACION:CAS_ZIP:BTN_SELECCIONAR_TRAMITE:ELIMINA_DOCUMENTO:'
