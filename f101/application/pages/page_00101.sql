...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'NUMERO_ORDEN:CIF_NIF:DOMICILIO:CODIGO_POSTAL:CODIGO_PROVINCIA:CODIGO_MUNICIPIO:CODIGO_PEDANIA:PERSONA_CONTACTO:TELEFONOS:FAX:CORREO_ELECTRONICO:ID_UTM:REFERENCIA_CATASTRAL:CUPS:DIRECCION_POR_DEFECTO:ID_GNSS:'
);
wwv_flow_imp_page.create_page_plug(
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(6113623345126831)
,p_event_id=>wwv_flow_imp.id(6112797171126823)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(6113256644126828)
,p_event_id=>wwv_flow_imp.id(6112797171126823)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(6113742737126832)
,p_event_id=>wwv_flow_imp.id(6112797171126823)
,p_event_result=>'TRUE'
